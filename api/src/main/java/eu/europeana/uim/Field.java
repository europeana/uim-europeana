 ...
 */
public final class Field<NS, T extends Serializable> implements Serializable, Comparable<Field<NS, T>> {
    ...
    private static Map<Field<?, ? extends Serializable>, Field<?, ? extends Serializable>> registry         
         = new HashMap<Field<?, ? extends Serializable>, Field<?, ? extends Serializable>>();
     ...
     * 
     */
    private Field(Class<NS> namespace, String name, Class<T> type) {
    ...
    public static <N, T extends Serializable> Field<N, T> register(Class<N> namespace, String name, Class<T> type) {
        if (namespace == null) { throw new IllegalArgumentException("Namespace must not be null."); }
        if (name == null) { throw new IllegalArgumentException("Name must not be null."); }
        if (type == null) { throw new IllegalArgumentException("Type must not be null."); }
        
        synchronized (registry) {
            Field<N, T> field = new Field<N, T>(namespace, name, type);

            Field<?, ? extends Serializable> featureKey = registry.get(field);
            if (featureKey != null) {
     ...
     */
    @SuppressWarnings("unchecked")
	public static <N, T extends Serializable> Field<N, T> resolve(Class<N> namespace, String name) {
        if (namespace == null) { throw new IllegalArgumentException("Namespace must not be null."); }
        if (name == null) { throw new IllegalArgumentException("Name must not be null."); }
        
        synchronized (registry) {
        	Field<N, T> field = new Field<N, T>(namespace, name, null);
    ...
    @Override
    public int compareTo(Field<NS, T> o) {
