...
//		Report report = Stub.getReport();
        ...
        try {
            ...
            generalnfoPhrase.add("\n");
            generalnfoPhrase.add(new Chunk("Collection name: ", FONT_TEXT));
            ...
            linkCheckingPhrase.add(new Chunk("Number of links checked within the collection: ", FONT_TEXT));
            linkCheckingPhrase.add(new Chunk(report.getNumber_links_checked() + "", FONT_TEXT));
            linkCheckingPhrase.add("\n");
            linkCheckingPhrase.add(new Chunk("Number of links successfully checked within the collection: ", FONT_TEXT));
            ...
            addTableLine(linkCheckingTable, EDM_OBJECT, report.getEdm_object_checked() + "", report.getEdm_object_checked_successful() + "", CHECKED);
            addTableLine(linkCheckingTable, EDM_IS_SHOWN_BY, report.getEdm_isshownby_checked() + "", report.getEdm_isshownby_checked_successful() + "", CHECKED);
            addTableLine(linkCheckingTable, EDM_IS_SHOWN_AT, report.getEdm_isshownat_checked() + "", report.getEdm_isshownat_checked_successful() + "", CHECKED);
            addTableLine(linkCheckingTable, EDM_HAS_VIEW, report.getEdm_hasview_checked() + "", report.getEdm_hasview_checked_successful() + "", CHECKED);
            document.add(linkCheckingTable);

            // Metadata Extraction
            Phrase metadataExtractionPhrase = new Phrase("Technical metadata extraction", FONT_CAPTION);
            linkCheckingPhrase.add("\n");
            linkCheckingPhrase.add(new Chunk("Number of links checked within the collection for which there was an attempt for technical metadata extraction: ", FONT_TEXT));
            linkCheckingPhrase.add(new Chunk(report.getNumber_metadata_extracted() + "", FONT_TEXT));
            linkCheckingPhrase.add("\n");
            linkCheckingPhrase.add(new Chunk("Number of links checked within the collection for which technical metadata extraction succeeded: ", FONT_TEXT));
...
//			addTableLine(metadataExtractionTable, EDM_IS_SHOWN_AT, report.getEdm_isshownat_processed() + "", report.getEdm_isshownat_processed_successful() + "", PROCESSED);
            ...
            previewCachingPhrase.add(new Chunk("Number of links checked within the collection for which there was an attempt for preview caching: ", FONT_TEXT));
    ...
    private static Report generateStatistics(String providerId, String collectionId, long dateStart, String recordsCount) {
        ...
        report.setTime_start(start.toString());
        // Date End - FIXME: hard-coded stub!
        report.setTime_end(new Date().toString());
...
//		report.setEdm_isshownat_processed_successful(metaExtractIsShownAtSuccess);
    ...
    private static void addTableLine(PdfPTable table, String prefix, String first, String second, String postfix) throws DocumentException {
        PdfPCell cell1 = new PdfPCell(new Paragraph(first, FONT_TEXT));
        cell1.setPaddingLeft(10);
        cell1.setHorizontalAlignment(Element.ALIGN_RIGHT);
        cell1.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell1.setBorderColor(BaseColor.WHITE);

        PdfPCell cell2 = new PdfPCell(new Paragraph(prefix + " values " + postfix, FONT_TEXT));
        cell2.setPaddingLeft(10);
        cell2.setHorizontalAlignment(Element.ALIGN_LEFT);
        cell2.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell2.setBorderColor(BaseColor.WHITE);

        PdfPCell cell3 = new PdfPCell(new Paragraph(second, FONT_TEXT));
        cell3.setPaddingLeft(10);
        cell3.setHorizontalAlignment(Element.ALIGN_RIGHT);
        cell3.setVerticalAlignment(Element.ALIGN_MIDDLE);
        cell3.setBorderColor(BaseColor.WHITE);

        PdfPCell cell4 = new PdfPCell(new Paragraph(prefix + " values successfully " + postfix, FONT_TEXT));
