...
public class FailedRecordsWidget extends IngestionWidget {
	...
	public FailedRecordsWidget(String name, String description,
			RepositoryServiceAsync repositoryService,
			FailedRecordServiceAsync retrievalService) {
	...
	public Widget onInitialize() {
		...
		cellTable = new CellTable<FailedRecordDTO>(FailedRecordDTO.KEY_PROVIDER);
	...
	private void updateRows(final CollectionDTO collection, final int offset,
			final int maxSize) {

		failedRecordRetrievalService.getFailedRecords(
				(String) collection.getMnemonic(), offset, maxSize,
