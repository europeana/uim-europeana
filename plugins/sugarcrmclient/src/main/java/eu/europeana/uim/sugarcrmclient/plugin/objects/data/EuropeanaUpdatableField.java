...
public enum EuropeanaUpdatableField implements UpdatableField{
	...
	RECORD_ID_POLICY("record_id_policy_c","record_id_policy_c", "Record ID Policy"),
	NAMESPACE_PREFIX("namespace_prefix_c", "namespace_prefix_c", "Namespace Prefix"),
	NAMESPACE_URI("namespace_uri_c", "namespace_uri_c", "Namespace URI"),
	IDXPATH("idxpath_c","idxpath_c", "IdXPath"),
