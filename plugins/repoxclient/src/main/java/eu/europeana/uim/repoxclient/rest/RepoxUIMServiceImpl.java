...
//         }
        ...
        AggregatorsAccessor aggregatorsAccessor = null;
        try {
          aggregatorsAccessor =
        ...
        as = aggregatorsAccessor;
        
        try {
          as.createAggregator("", "ExampleName", "ExampleNs", "http://example.com");
    ...
    initializer.initialize(RepoxRestClientImpl.class.getClassLoader());
  }
   ...
   * (non-Javadoc)
   * 
   * @see eu.europeana.uim.repox.RepoxUIMService#createAggregator(java.lang.String,
   * java.lang.String)
   */
  @Override
...
//    repoxRestClient.createAggregator(aggr);
   ...
   * (non-Javadoc)
   * 
   * @see eu.europeana.uim.repox.RepoxUIMService#updateAggregator(java.lang.String,
   * java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public void updateAggregator(String countryCode, String aggrname, String aggrNameCode,
      String urlString) throws AggregatorOperationException {
   ...
   * (non-Javadoc)
   * 
   * @see eu.europeana.uim.repox.RepoxUIMService#initializeExport(eu.europeana.uim.store.Collection,
   * int)
   */
  @Override
